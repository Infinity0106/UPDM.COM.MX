...
function emailFormSubmission()
{
	...
	$to = 'soporteupdm@gmail.com, mexico@avacomglobal.com';
	...
	$headers = 'From: soporteupdm@gmail.com' . PHP_EOL . 'Reply-To: ' . $formEmail . PHP_EOL .'X-Mailer: Adobe Muse 2014.0.328 with PHP/' . phpversion() .'/'. PHP_OS . PHP_EOL . 'Content-type: text/html; charset=utf-8' . PHP_EOL;
